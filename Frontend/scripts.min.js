...
;
function applicationModel(){var n=this;n.applicationName=ko.observable();n.appNameAndVersion=ko.computed(function(){return n.applicationName()},n);n.user=ko.observable(new userModel);n.showUser=ko.computed(function(){return n.user().name()!=null&&n.user().name().length>0},n);n.busyContainers=ko.observableArray([]);n.addProgressIndicator=function(t){var i=new busyDialogModel(t);n.busyContainers.push(i)};n.logoutClick=function(){auth.logout()};n.toggleNavBar=function(){var n=document.getElementById("smallNavbar");n.className.indexOf("w3-show")==-1?n.className+=" w3-show":n.className=n.className.replace(" w3-show","")};n.closeNavBar=function(){var n=document.getElementById("smallNavbar");n.className.indexOf("w3-show")>-1&&(n.className=n.className.replace(" w3-show",""))};n.modalDialogs=ko.observableArray([]);n.addModalDialog=function(t){n.modalDialogs.push(t);var i=document.getElementById("modalDlg_"+_applicationModel.modalDialogs().length);i=i.firstChild;i.focus();ko.cleanNode(i);ko.applyBindings(t.model,i)};n.views=ko.observableArray([]);n.currentView=ko.observableArray([]);n.addView=function(t){for(var u=n.views(),i=null,r=0;r<u.length;r++)if(u[r].id==t.id){i=t;break}i==null&&(i=t);n.currentView([i]);i.applyKoBindings()};n.menuContainer=ko.observable(new menuContainer)}function busyDialogModel(n){var t=this;t.busyText=ko.observable(n)}function userModel(n,t,i){var r=this;r.id=n;r.name=ko.observable(t);r.role=i};
function passwordResetModel(){var n=this;n.emailOrUsername=ko.observable();n.cancelClick=function(){dialog.closeModalDialog();auth.logout()};n.resetPasswordClick=function(){var i=mainApp.apiURL+"menu/RequestPasswordReset",t={usernameOrEmail:n.emailOrUsername()};t=JSON.stringify(t);dialog.showBusyDialog("Resetting password...");mainApp.makeWebCall(i,"POST",t).then(function(n){return dialog.closeBusyDialog(),dialog.showMessage("Info",n)}).then(dialog.closeBusyDialog).then(dialog.closeModalDialog).then(auth.logout)}}function loginModel(){var n=this;n.userName=ko.observable();n.password=ko.observable();n.loginClick=function(){auth.performLogin(n.userName(),n.password())};n.forgotPasswordClick=function(){dialog.closeModalDialog().then(dialog.showPasswordResetDialog)};n.passwordKeyPressed=function(t,i){return i.keyCode==13&&n.loginClick(),!0}}(function(n,t){n.accessToken="";n.refreshToken="";n.lastTokenRefresh="";var i="",r="",u="";n.initialize=function(){return new Promise(function(t){var f,e;i=_applicationModel.appNameAndVersion()+"_accessToken";r=_applicationModel.appNameAndVersion()+"_refreshToken";u=_applicationModel.appNameAndVersion()+"_lastTokenRefresh";console.log("refresh storage names:\n",i,"\n",r,"\n",u);n.accessToken=localStorage.getItem(i);n.refreshToken=localStorage.getItem(r);n.lastTokenRefresh=localStorage.getItem(u);f=n.lastTokenRefresh||"";(f==null||f.length==0)&&(f=JSON.stringify(new Date));f=new Date(JSON.parse(f));e=new Date;f.setHours(0,0,0,0)<e.setHours(0,0,0,0)?(console.log("last refresh was before today"),n.performTokenRefresh().catch(function(n){console.error("Error performing auth refresh",n);t()}).then(t)):t()})};n.handleLoginSuccess=function(t){return console.log("handling login success",t),_applicationModel.user().name(t.userName),n.accessToken=t.access_token,n.refreshToken=t.refresh_token,localStorage.setItem(i,n.accessToken),localStorage.setItem(r,n.refreshToken),localStorage.setItem(u,JSON.stringify(new Date)),Promise.resolve()};n.logout=function(){return n.accessToken="",n.refreshToken="",localStorage.setItem(i,""),localStorage.setItem(r,""),_applicationModel.user(new userModel),mainApp.startApplication()};n.performLogin=function(t,i){var r=mainApp.apiURL+"token",u="grant_type=password&username="+t+"&password="+i+"&client_id="+_applicationModel.applicationName();return dialog.showBusyDialog("Logging in..."),mainApp.makeWebCall(r,"POST",u).then(n.handleLoginSuccess).then(mainApp.startApplication).then(dialog.closeBusyDialog).then(dialog.closeModalDialog)};n.performTokenRefresh=function(){console.log("performing token refresh");var i=mainApp.apiURL+"token?v="+mainApp.version,r={grant_type:"refresh_token",refresh_token:n.refreshToken,client_id:_applicationModel.applicationName()};return new Promise(function(f,e){t.ajax({url:i,method:"POST",data:r}).done(function(t){console.warn("successfully got new refresh token");console.warn(t);localStorage.setItem(u,JSON.stringify(new Date));n.handleLoginSuccess(t).then(dialog.closeBusyDialog).then(f)}).fail(function(n){console.warn("unable to refresh token");console.warn(n);e(n)})})}})(window.auth=window.auth||{},jQuery);
(function(n){n.encode=function(n){return btoa(encodeURIComponent(n).replace(/%([0-9A-F]{2})/g,function(n,t){return String.fromCharCode("0x"+t)}))};n.decode=function(n){return decodeURIComponent(Array.prototype.map.call(atob(n),function(n){return"%"+("00"+n.charCodeAt(0).toString(16)).slice(-2)}).join(""))}})(window.base64=window.base64||{},jQuery);
...
(function(n){function u(n){var t=new passwordResetModel,r=new i(n,t,_applicationModel.modalDialogs().length+1);return _applicationModel.addModalDialog(r),Promise.resolve()}function r(){try{var n=new loginModel,r=new i(t,n,_applicationModel.modalDialogs().length+1);_applicationModel.addModalDialog(r)}catch(u){console.error(u)}return Promise.resolve()}function f(t,i,r,u,f,e,o){var s=this;s.message=ko.observable(t);s.confirmationText=ko.observable(i);s.cancelText=ko.observable(u);s.confirmClick=function(){n.closeModalDialog();r>0?(n.showBusyDialog("Processing..."),mainApp.executeUIAction(r,o).then(n.closeBusyDialog).then(e)):e()};s.cancelClick=function(){n.closeModalDialog();f>0?(n.showBusyDialog("Processing..."),mainApp.executeUIAction(f,o).then(n.closeBusyDialog).then(e)):e()}}function e(t,i,r){var u=this;u.heading=t;u.message=i;u.closeClick=function(){n.closeModalDialog();r()};u.errorTypeColor=ko.computed(function(){switch(u.heading.toLowerCase()){case"info":return"w3-green";case"warn":case"warning":return"w3-orange";case"error":return"w3-red";default:return"w3-green"}},u)}function i(n,t,i){var r=this;r.html=ko.observable(n);r.model=t;r.myid=ko.observable(i)}var t="";n.showBusyDialog=function(n){return _applicationModel.addProgressIndicator(n),Promise.resolve()};n.getUserConfirmation=function(t,i,r){n.closeAllBusyDialogs();var u=t.CancelButtonText,e=t.ConfirmationButtonText,o=t.ConfirmationMessage,s=t.OnConfirmationUIAction,h=t.OnCancelUIAction;return new Promise(function(t){i=i||{};i.parameters=r;var c=new f(o,e,s,u,h,t,i);return n.showDialogWithId("confirmation",c)})};n.closeAllBusyDialogs=function(){while(_applicationModel.busyContainers().length>0)_applicationModel.busyContainers.pop()};n.closeBusyDialog=function(){var n=_applicationModel.busyContainers()[_applicationModel.busyContainers().length-1];return n==null&&(console.warn("closing busy dialog called, but model is null"),console.log("this is because of the code inside getUserConfirmation")),_applicationModel.busyContainers.pop(),Promise.resolve()};n.closeModalDialog=function(){return _applicationModel.modalDialogs.pop(),Promise.resolve()};n.showDialogWithId=function(t,i){return mainApp.makeWebCall("frontend/pages/"+t+".html").then(function(t){return n.showDialog(t,i)})};n.showDialog=function(n,t){var r=new i(n,t,_applicationModel.modalDialogs().length+1);return _applicationModel.addModalDialog(r),Promise.resolve()};n.showLoginDialog=function(){return t.length==0?mainApp.makeWebCall("Frontend/Pages/Login.html").then(function(n){return t=n,r()}):r()};n.showPasswordResetDialog=function(){return mainApp.makeWebCall("Frontend/Pages/PasswordResetRequest.html").then(function(n){return u(n)})};n.showMessage=function(t,i){return new Promise(function(r){var u=new e(t,i,r);n.showDialogWithId("dialog",u)})}})(window.dialog=window.dialog||{},jQuery);
function listSourceItemModel(n,t,i){var r=this;r.selected=ko.observable(n);r.label=ko.observable(t);r.value=i}(function(n,t){function i(n,i,r){var u=this;u.eventId=i;u.title=ko.observable(n);u.tabs=ko.observableArray([]);u.currentTab=ko.observable();u.combinedTab=ko.observable();u.buttons=ko.observableArray([]);u.params=r;u.closeClick=function(){dialog.closeModalDialog()};u.getInputs=function(n){var t=u.tabs().slice(0),i;return t.push(u.combinedTab()),i=function(t){return t!=null?t.getInputs(n):[]},Promise.all(t.map(i))};u.buttonClick=function(n){dialog.showBusyDialog("Processing...").then(function(){return u.getInputs(n.validateInput).then(function(i){var r={};return t.each(i,function(n,i){t.extend(r,r,i)}),r.parameters=u.params,mainApp.processEvent(u.eventId,n.actionNumber,r)}).catch(function(n){n=="X"||mainApp.handleError(n)})}).then(dialog.closeBusyDialog).catch(function(n){console.error(n);mainApp.handleError(n)})};u.toggleInputVisibility=function(n,i){var r,f=u.tabs().slice(0),e=u.combinedTab(),o;e!=null&&f.push(e);o=t.each(f,function(i,u){return u==null?!1:(t.each(u.inputs(),function(t,i){return i==null?!1:i.setting.InputName==n?(r=i,!1):void 0}),r!=null?!1:void 0)});r!=null&&r.visible(i)};u.findInputModelWithName=function(n){var f=u.tabs().slice(0)||[],i,r;return(f.push(u.combinedTab()),i=t.grep(f,function(t){var i=t.findInputModelWithName(n);return i.length>0}),i.length==0)?null:(r=i[0].findInputModelWithName(n),r.length==0)?null:r[0]}}function r(n,i){var r=this;r.inputDialogModel=i;r.tabName=ko.observable(n);r.selected=ko.computed(function(){return r.inputDialogModel.currentTab()==r},r);r.setCurrentTab=function(){if(r.inputDialogModel.currentTab()!=r){r.inputDialogModel.currentTab(r);var n=r.inputs();t.each(n,function(n,t){t.viewModel!=null&&t.viewModel.applyKoBindings()})}else r.inputDialogModel.currentTab(r)};r.colorClass=ko.computed(function(){return r.selected()==!0?"w3-grey":"w3-light-grey"},r);r.inputs=ko.observableArray([]);r.findInputModelWithName=function(n){return t.grep(r.inputs(),function(t){return t.setting.InputName==n})};r.getInputs=function(n){var i={},u=function(n){return new Promise(function(t,i){var f=n.ColumnName,u=r.inputDialogModel.findInputModelWithName(f);u==null?(console.error("inpModel is null"),t(!1)):u.getInputValue().then(function(i){var r=processing.isConditionMet(n,i);t(r)}).catch(i)})},f=function(r){var e=n,f=null;return new Promise(function(n,o){r.getInputValue().then(function(s){if(e&&(s==null||s.length==0)&&r.mandatory==!0&&r.visible()==!0)return dialog.closeBusyDialog(),dialog.showMessage("Warning",r.setting.InputLabel+" is mandatory").then(function(){o("X")});if(e&&(s==null||s.length==0)&&r.setting.MandatoryConditions!=null&&r.setting.MandatoryConditions.length>0&&r.visible()==!0){var h=t.map(r.setting.MandatoryConditions,u);f=function(){return Promise.all(h).then(function(n){if(n.indexOf(!1)==-1)return dialog.closeBusyDialog(),dialog.showMessage("Warning",r.setting.InputLabel+" is mandatory").then(function(){console.error("reject "+r.setting.InputName);o("X")})})}}i[r.setting.InputName]=s;f!=null?f().then(n):n()}).catch(function(n){console.error(n);o(n)})})},e=r.inputs(),o=t.map(e,f);return Promise.all(o).then(function(){return Promise.resolve(i)})}}function u(n,i){var r=this;r.setting=n;r.inputDialogModel=i;r.inputLabel=ko.observable(n.InputLabel);r.inputValue=ko.observable();r.dateFormat="dd-mm-yy";n.InputType==10&&(r.Step=n.Step);r.multiLine=n.MultiLineText;r.inputType=n.InputType;r.mandatory=n.Mandatory;r.raisePropertyChangeEvent=n.RaisePropertyChangedEvent;r.visible=ko.observable(n.InputType!=2);r.propertyChanged=function(){r.raisePropertyChangeEvent==!0&&(dialog.showBusyDialog("Processing input..."),r.getInputValue().then(function(n){var t={Data:{PropertyName:r.setting.InputName,PropertyValue:n,EventId:r.inputDialogModel.eventId}};return Promise.resolve(t)}).then(function(n){return mainApp.raisePropertyChanged(n,r.inputDialogModel.eventId)}).then(function(){dialog.closeBusyDialog()}).catch(mainApp.handleError))};r.listItems=ko.observableArray(n.ListItems!=null?n.ListItems:[]);r.options=ko.computed(function(){var t,i,n,u,e;if(r.inputType!=3)return[];for(t=[],i=r.listItems(),n=0;n<i.length;n++)u=i[n],e=new f(u.Value,u.Key),t.push(e);return t},r);r.setInputValue=function(n){var u,i,t;switch(r.inputType){case 3:for(u=!1,i=r.options(),t=0;t<i.length;t++)if(i[t].value==n){r.inputValue(i[t]);u=!0;break}u==!1&&r.inputValue("");break;case 5:break;case 6:r.inputValue(n);break;case 8:break;case 9:r.inputValue(n);break;default:r.inputValue(n)}};r.getInputValue=function(){var n=r.inputValue(),i,o,f,e,u;switch(r.inputType){case 3:return n!=null&&(n=n.value),Promise.resolve(n);case 4:return n==null&&(n="false"),n=n+"",Promise.resolve(n);case 5:return i=r.listSource(),i=t.grep(i,function(n){return n.selected()==!0}),o=t.map(i,function(n){return n.value}),n=o,Promise.resolve(n);case 6:return n=n||"",Promise.resolve(n);case 8:return f=r.viewModel,f!=null?(e={},f.addViewDataToParams(e),Promise.resolve(e)):Promise.resolve(null);case 9:return u=r.inputValue(),u!=null?new Promise(function(n){var i=new FileReader,t=null;i.onload=function(i){return function(r){var o;t=r.target.result;t=window.btoa(t);var u=i.name,f=u.split("."),e="";f.length>1&&(e=f[1]);u=f[0];o={Data:t,FileName:u,MimeType:i.type,FileExtension:e,Size:i.size};n(o)}}(u);i.readAsBinaryString(u)}).catch(function(n){console.error(n);mainApp.handleError(n)}):Promise.resolve(null);default:return Promise.resolve(n)}};r.fileSelected=function(n){r.setInputValue(n);r.propertyChanged()};r.id=n.InputName;r.html=ko.observable();r.listSource=ko.observableArray([]);r.selectAll=ko.observable(!1);r.selectAllClicked=function(){var n=r.listSource();return t.each(n,function(n,t){t.selected(r.selectAll())}),!0};r.listSourceSelect=function(){return r.selectAll(r.isAllListSelected()),!0};r.isAllListSelected=function(){var n=r.listSource(),i=t.grep(n,function(n){return n.selected()==!0});return n.length==i.length};r.initialized=!1;r.viewModel=null;r.initialize=function(n){return dialog.showBusyDialog("Initializing...").then(function(){var i=r.setting,f,u;switch(r.inputType){case 5:f=n||[];u=i.ListSource;u=t.map(u,function(n){var t=f.indexOf(n.Key)>-1;return new listSourceItemModel(t,n.Value,n.Key)});r.listSource(u);r.selectAll(r.isAllListSelected());break;case 8:views.showView(i.ViewForInput,!0,i.ViewForInput.Id).then(function(t){r.viewModel=t;r.html(t.html());t.applyKoBindings();t.updateViewData(i.ViewForInput.Id,n)}).catch(function(n){mainApp.handleError(n)});break;case 6:n!=null&&n.length>0&&r.setInputValue(n);break;case 10:r.setInputValue(n);break;default:r.setInputValue(n)}return r.propertyChanged(n),dialog.closeBusyDialog()}).catch(function(n){console.error(n);mainApp.handleError(n)})}}function f(n,t){var i=this;i.displayText=n;i.value=t}function e(n,t,i){var r=this;r.label=t;r.actionNumber=n;r.validateInput=i}n.conditionIsMet=function(n,t){return n.Comparison==0?t===n.ColumnValue:n.Comparison==1?t!=n.ColumnValue:n.Comparison==2?t.indexOf(n.ColumnValue)>-1:n.Comparison==3?t!=null&&(t+"").length>0:n.Comparison==4?t==null||(t+"").length==0:(dialog.showMessage("Error","Unknown comparison: "+n.Comparison),!1)};n.buildInput=function(f){var a=f.Description,v=f.InputButtons,y=f.InputData,h=f.InputFields,o=new i(a,f.Id,f.Parameters),s={},c=[],l;return t.each(h,function(i,f){var l=t.trim(f.TabName||""),e,a;s[l]==null&&(s[l]=new r(l,o));e=new u(f,o);e.inputValue.subscribe(function(){var i=e;i.getInputValue().then(function(r){for(var f=t.grep(h,function(n){var r=t.grep(n.VisibilityConditions,function(n){return n.ColumnName==i.setting.InputName});return r.length>0}),u=0;u<f.length;u++){var e=f[u],s=t.grep(e.VisibilityConditions,function(t){return t.ColumnName==i.setting.InputName&&n.conditionIsMet(t,r)}),c=s.length>0;o.toggleInputVisibility(e.InputName,c)}})});a=function(){return e.initialize(f.DefaultValue)};c.push(a);s[l].inputs.push(e)}),t.each(s,function(n,t){n==""?o.combinedTab(t):o.tabs.push(t)}),o.tabs().length>0&&(l=o.tabs()[0],o.currentTab(l)),t.each(v,function(n,t){var i=new e(t.ActionNumber,t.Label,t.ValidateInput);o.buttons.push(i)}),dialog.showDialogWithId("InputDialog",o).then(function(){var n=function(n){return n()};return Promise.all(t.map(c,n)).then(function(){return o.tabs().length>0&&o.currentTab(),Promise.resolve()})})};n.updateInputVisibility=function(n,t){var i=_applicationModel.modalDialogs(),u=i[i.length-1],f=u.model,r=f.findInputModelWithName(n);return r==null?dialog.showMessage("Error","Unexpected error, no input found with name "+n):(r.visible(t),Promise.resolve())};n.updateInput=function(n,t){var i=_applicationModel.modalDialogs(),u=i[i.length-1],f=u.model,r=f.findInputModelWithName(n);return r==null?dialog.showMessage("Error","Unexpected error, no input found with name "+n):(r.setInputValue(t),Promise.resolve())}})(window.inputDialog=window.inputDialog||{},jQuery);
...
var _applicationModel;$(document).ready(function(){_applicationModel=new applicationModel;ko.applyBindings(_applicationModel,$("body")[0]);mainApp.initializeApplication()}),function(n,t){n.baseURL="https://"+window.location.host+window.location.pathname;n.apiURL="api/v1/";n.version="";n.initializeApplication=function(){return dialog.showBusyDialog("Initializing..."),n.makeWebCall(n.apiURL+"initializeSystem").then(function(t){var r=t.ApplicationName,u=t.Version,i=t.ConstructorError;return i!=null&&i.length>0&&(console.log("There was a constructor error:"),console.log(i)),n.version=u,_applicationModel.applicationName(r),document.title=r+" "+u,n.startApplication()}).then(dialog.closeBusyDialog)};n.startApplication=function(){return _applicationModel.views([]),_applicationModel.currentView([]),console.clear(),console.log("start app"),auth.initialize().then(n.initialize).then(menus.loadMenu).catch(function(t){var i,r,u,f;return(dialog.closeBusyDialog(),console.error(t),t.indexOf("AnonAction:")>-1)?(i=n.getParameterByName("anonAction"),r=n.getParameterByName("params"),dialog.closeModalDialog(),n.executeUIAction(i,r,!0)):t.indexOf("Confirmed:")>-1?(u=t.split(":"),f=u[1],dialog.showMessage("Info","Thank you for confirming you email address. You can now log in using your username and password").then(function(){return window.location.href=window.location.href.split("?")[0].split("#")[0],auth.logout()})):n.handleError(t)})};n.initialize=function(){var r=n.getParameterByName("anonAction"),t,i;return r!=null&&r.length>0?Promise.reject("AnonAction:"+r):(t=n.getParameterByName("confirmed"),t!=null&&t.length>0)?Promise.reject("Confirmed:"+t):(i=n.getParameterByName("errors"),i!=null&&i.length>0)?Promise.reject(i):n.makeWebCall(n.apiURL+"initialize").then(function(n){var t=n.User,i=n.Role,r=n.Id,u=new userModel(r,t,i);return _applicationModel.user(u),Promise.resolve()})};n.getParameterByName=function(n,t){(t==null||t.length==0)&&(t=window.location.href);n=n.replace(/[\[\]]/g,"\\$&");var r=new RegExp("[?&]"+n+"(=([^&#]*)|&|#|$)"),i=r.exec(t);return i?i[2]?decodeURIComponent(i[2].replace(/\+/g," ")):"":null};n.handleError=function(n){var t,i;if(console.trace(),console.error(n),t=n,n.responseText!=null){t=n.responseText;try{i=JSON.parse(t);i.Message!=null&&(t=i.Message)}catch(r){console.log(r)}}return n.stack!=null&&(t+=":\n"+n.stack),dialog.closeAllBusyDialogs(),dialog.showMessage("Error",t),Promise.resolve()};n.executeUIAction=function(t,i){return new Promise(function(r){var u={Data:i||""},f;return u=JSON.stringify(u),f=n.apiURL+"executeUIAction/"+t,n.makeWebCall(f,"POST",u).then(function(i){return n.processUIActionResult(i,t)}).then(r)}).catch(function(t){n.handleError(t)})};n.processEvent=function(t,i,r){var u={Data:r||"",ActionId:i},f;return u=JSON.stringify(u),f=n.apiURL+"processEvent/"+t,n.makeWebCall(f,"POST",u).then(function(i){return n.processUIActionResult(i,t)})};n.raisePropertyChanged=function(t,i){t=JSON.stringify(t);var r=n.apiURL+"propertyChanged/"+i;return n.makeWebCall(r,"POST",t).then(function(t){return n.processUIActionResult(t,i)})};n.processUIActionResult=function(t,i){return processing.processUIActionResult(t,i).catch(function(t){return n.handleError(t)})};n.makeWebCall=function(i,r,u,f){var e=i;return i.indexOf("http")==-1&&(e=n.baseURL+i),new Promise(function(o){t.ajax({url:e+"?v="+n.version,data:u,method:r||"GET",crossDomain:!0,cache:i.indexOf("html")>-1,beforeSend:function(n){n.setRequestHeader("Authorization","Bearer "+auth.accessToken)}}).done(function(n,t,i){var r,u,e;if(f==null||f.length==0)o(n);else{for(r={},r.data=n,u=0;u<f.length;u++)e=f[u],r[e]=i.getResponseHeader(e);o(r)}}).fail(function(t){if(console.error("Error while trying to call /"+i),console.error(t.status+": "+t.statusText),t.status==401){if(auth.refreshToken!=null&&auth.refreshToken.length>0)return console.warn("auth no longer valid, trying to get a new access token"),auth.performTokenRefresh().then(function(){return console.warn("refresh token updated successfully"),n.makeWebCall(i,r,u).then(function(n){o(n)})}).catch(function(n){console.error(n);dialog.closeBusyDialog();dialog.showLoginDialog()});dialog.showLoginDialog()}else t.status==400&&t.responseText.indexOf("invalid_grant")>-1?dialog.showMessage("Error","Username or password incorrect, try again."):n.handleError(t);dialog.closeBusyDialog()})})}}(window.mainApp=window.mainApp||{},jQuery);
function menuModel(n,t,i){var r=this;r.id=n;r.name=ko.observable(t);r.eventId=i;r.parentMenu=null;r.menuClick=function(){if(r.eventId!="back"&&r.eventId!=null&&_applicationModel.closeNavBar(),dialog.showBusyDialog("Processing..."),r.eventId=="home")_applicationModel.menuContainer().currentParent(null),mainApp.startApplication().then(dialog.closeBusyDialog);else if(r.eventId=="back"){var n=_applicationModel.menuContainer().currentParent();_applicationModel.menuContainer().currentParent(n.parentMenu);dialog.closeBusyDialog()}else r.eventId==null?(_applicationModel.menuContainer().currentParent(r),dialog.closeBusyDialog()):mainApp.executeUIAction(r.eventId).then(dialog.closeBusyDialog);return Promise.resolve()}}function menuContainer(){var n=this;n.allMenus=ko.observableArray([]);n.currentParent=ko.observable();n.currentMenuList=ko.computed(function(){var t=n.currentParent(),i=n.allMenus();return $.grep(i,function(n){return n.parentMenu==null||t==null?t==null&&n.parentMenu==null:n.parentMenu.id==t.id})},n);n.home=ko.observable(new menuModel(null,"Home","home"));n.back=ko.observable(new menuModel(null,"<<","back"))}(function(n){n.loadMenu=function(){return mainApp.makeWebCall(mainApp.apiURL+"getUserMenu").then(function(t){var i=n.getMenus(t,null);_applicationModel.menuContainer().allMenus(i)})};n.getMenus=function(t,i){for(var r,u=[],e=0;e<t.length;e++){var f=t[e],s=f.Event,h=f.Id,c=f.Name,o=new menuModel(h,c,s);o.parentMenu=i;r=f.SubMenus;u.push(o);r!=null&&(r=n.getMenus(r,o),u=u.concat(r))}return u}})(window.menus=window.menus||{},jQuery);
...
(function(n,t){n.processUIActionResult=function(i,r){return views.currentView=-1,i=i||[],Promise.all(i.map(function(i){var h,f,v,s,y,c,p,a,b,o,u,l,k;try{h=i.ActionType;f=i.Parameters;f!=null&&f.length>0||(f={});switch(h){case 0:return o=_applicationModel.views(),u=t.grep(o,function(n){return n.id==i.Id}),u.length==0?views.showView(i,!1,i.Id).then(function(n){_applicationModel.addView(n)}):(_applicationModel.addView(u[0]),u[0].gotoPage(1),Promise.resolve());case 1:return inputDialog.buildInput(i);case 4:return dialog.closeModalDialog();case 5:return dialog.getUserConfirmation(i,i.Data,f);case 6:return dialog.showBusyDialog("Processing...").then(function(){return mainApp.executeUIAction(i.EventNumber,i.ParametersToPass).then(dialog.closeBusyDialog)});case 8:case 9:return f=JSON.parse(f),v=f.ViewId,s=f.RowId,s==null&&(s=-1),y=i.UpdateType,c=i.JsonDataToUpdate,c=JSON.parse(c),p=document.getElementById("view_"+v),a=ko.contextFor(p).$rawData,y==0&&h==8?a.updateRow(s,c):a.deleteRow(s);case 10:var w=_applicationModel.modalDialogs(),d=w[w.length-1].model,e=d.findInputModelWithName(i.InputName);return e.getInputValue().then(function(n){if(e.inputType==5){var u=n||[],r=i.ListItems;r=t.map(r,function(n){var t=u.indexOf(n.Key)>-1;return new listSourceItemModel(t,n.Value,n.Key)});e.listSource(r);e.selectAll(e.isAllListSelected())}else e.listItems(i.ListItems),e.setInputValue(n)});case 11:return n.showOrDownloadFile(i);case 12:return l=i.InputName,b=i.InputValue,inputDialog.updateInput(l,b);case 13:return dialog.closeModalDialog(),auth.logout().then(function(n){return window.location.href=window.location.href.split("?")[0].split("#")[0],Promise.resolve(n)});case 14:return o=_applicationModel.views(),u=t.grep(o,function(n){return n.id==i.Id}),u.length==0?views.showListView(i,!1,i.Id).then(function(n){_applicationModel.addView(n)}):(_applicationModel.addView(u[0]),u[0].gotoPage(1),Promise.resolve());case 15:return o=_applicationModel.views(),u=t.grep(o,function(n){return n.id==i.Id}),u.length==0?views.showDetailsView(i,!1,i.Id).then(function(n){_applicationModel.addView(n)}):(_applicationModel.addView(u[0]),u[0].gotoPage(1),Promise.resolve());case 17:return l=i.InputName,k=i.InputIsVisible,inputDialog.updateInputVisibility(l,k);default:return console.warn(i),dialog.closeBusyDialog(),dialog.showMessage("Error","Unknown action type: "+h+" for event "+r)}}catch(g){return Promise.reject(g)}})).catch(function(n){return mainApp.handleError(n)})};n.showOrDownloadFile=function(n){var i,r;return dialog.showBusyDialog("Downloading file..."),i=mainApp.apiURL+n.DataUrl,i=i.replace("//","/"),r="",n.RequestData!=null&&(r=base64.encode(n.RequestData)),new Promise(function(n){t.ajax({url:i,type:"POST",data:r,xhrFields:{responseType:"blob"},dataType:"binary",beforeSend:function(n){n.setRequestHeader("Authorization","Bearer "+auth.accessToken)}}).done(function(t,i,r){var u,e,f;r&&r.getResponseHeader&&(u=r.getResponseHeader("FileName"));(u==null||u.length==0)&&(u="unknown file.zip");window.navigator&&window.navigator.msSaveBlob?window.navigator.msSaveBlob(t,u):(e=URL.createObjectURL(t),f=document.createElement("a"),f.href=e,f.download=u,document.body.appendChild(f),f.click(),URL.revokeObjectURL(e),f.remove());dialog.closeBusyDialog();n()}).fail(function(t,i,r){console.error(r);dialog.showMessage("Error","Error downloading file: \n"+r);dialog.closeBusyDialog();n()})}).catch(function(n){console.error(n);dialog.showMessage("Error","Error downloading file: \n"+n);dialog.closeBusyDialog();res()})};n.updateViewData=function(n,t){var i={Data:t||""},r;return i=JSON.stringify(i),r=mainApp.apiURL+"updateViewData/"+n,mainApp.makeWebCall(r,"POST",i)};n.loadViewMenu=function(n,t,i){dialog.showBusyDialog("Loading view menu...");var u=mainApp.apiURL+"getViewMenu/"+n,r={data:i};return r=JSON.stringify(r),mainApp.makeWebCall(u,"POST",r).then(function(n){var u=n||[],f={},r,i,e;for(f.ViewId=t.id,r=0;r<u.length;r++)i=u[r],e=new views.viewMenuModel(i.Label,i.EventNumber,i.ParametersToPass,f,i.IncludeDataInView),t.viewMenus.push(e);dialog.closeBusyDialog()})};n.cellIsVisible=function(t,i){var f,r,u;if(t.ColumnSetting!=null&&t.ColumnSetting.ColumnSettingType==0){for(f=t.ColumnSetting.Display==0,r=!0,u=0;u<t.ColumnSetting.Conditions.length;u++){var e=t.ColumnSetting.Conditions[u],o=e.ColumnName,s=n.parseColumnName(o,i)+"";r=r&&n.isConditionMet(e,s)}if(r==!1&&f==!0||r==!0&&f==!1)return!1}return!0};n.isConditionMet=function(n,t){var u=n.ColumnName,r=n.Comparison,i=n.ColumnValue;switch(r){case 0:return t==i;case 1:return t!=i;case 2:return t.toLowerCase().indexOf(colValue.toLowerCase())>-1;case 3:return t!=null&&t.length>0;case 4:return t==null||t.length==0;case 5:return t=parseInt(t),t!=null&&t>i;case 6:return t=parseInt(t),t!=null&&t>=i;case 7:return t=parseInt(t),t!=null&&t<i;case 8:return t=parseInt(t),t!=null&&t<=i;default:dialog.showMessage("Error","Unknown condition comparison type: "+r)}return!0};n.parseColumnName=function(n,t){var i="",r,u,f;if(n!=null&&n.length>0){for(i=t,r=n;r.indexOf(".")>-1;){if(u=r.indexOf("."),f=r.substring(0,u),i==null)break;i=i[f];r=r.substring(u+1)}i!=null&&(i=i[r])}return i};n.getColumnValue=function(t,i){var u=t.ColumnName,f=t.ColumnType,r=n.parseColumnName(u,i);switch(f){case 1:r==!0?r=t.TrueValueDisplay:r==!1&&(r=t.FalseValueDisplay);break;case 2:case 3:r=t.LinkLabel;break;default:r==null&&(r="");typeof r=="object"?r=JSON.stringify(r):(r=r.toString(),r=r.replace(/\r/g,","),r=r.replace(/\n/g,","))}return r}})(window.processing=window.processing||{},jQuery);
...
"function"!=typeof Promise.prototype.done&&(Promise.prototype.done=function(){var n=arguments.length?this.then.apply(this,arguments):this;n.then(null,function(n){setTimeout(function(){throw n;},0)})});
(function(n,t){function u(t,i){setTimeout(function(){n.currentView==t.id?(console.log("refreshing: "+t.viewTitle()),t.filterSearchClick(),u(t,i)):console.log("stopping auto refresh for "+t.viewTitle()+" because id is no longer the same")},i)}function i(n,t,i,r){var u=this;u.id=n;u.label=ko.observable(t);u.visible=ko.observable(i);u.columnSpan=ko.observable(r||1)}function f(n,t,i,r){var u=this;u.format="";u.value=ko.observable(n);u.showCell=ko.observable(t);u.columnType=ko.observable(i);u.columnSpan=ko.observable(r||1);u.dateValue=ko.computed(function(){return u.columnType()==5?e(n,u.format):""},u)}function e(n){return console.log("formatting date"),console.log(n),n}function o(n,t){var i=this;i.id=t;i.data=n;i.cells=ko.observableArray([])}function r(i,r,u,e,s,h){var c=this;c.settings=u;c.id=s;c.linesPerPage=ko.observable(u.LinesPerPage);c.detailIsHtml=ko.observable(!1);c.isEmbeddedView=e;c.lastPage=ko.computed(function(){var n=Math.floor(c.settings.TotalLines/c.linesPerPage());return c.settings.TotalLines%c.linesPerPage()>0&&(n+=1),Math.max(1,n)},c);c.currentPage=ko.observable(c.settings.CurrentPage);c.footerText=ko.computed(function(){return"Showing page "+c.settings.CurrentPage+" of "+c.lastPage()},c);c.viewTitle=ko.observable(i);c.viewMessage=ko.observable(h);c.viewMenus=ko.observableArray([]);c.menuClick=function(n){dialog.showBusyDialog("Processing...").then(function(){var t={data:n.menuParams,parameters:n.viewParams};return n.includeDataInView==!0&&c.addViewDataToParams(t),mainApp.executeUIAction(n.eventId,t)}).then(dialog.closeBusyDialog)};c.addViewDataToParams=function(n){var r=c.rows(),u=t.map(r,function(n){return n.data}),i=n.data;(i==null||i.length==0)&&(i={});i=typeof i=="object"?JSON.parse(JSON.stringify(i)):JSON.parse(i);i.ViewData=u;i.Filter=c.filterText();n.data=i};c.filterText=ko.observable(u.Filter);c.filterSearchClick=function(){var n={viewSettings:{currentPage:c.settings.CurrentPage,linesPerPage:c.settings.LinesPerPage,totalLines:-1},filter:c.filterText(),parameters:c.settings.Parameters,eventParameters:c.settings.EventParameters};c.updateViewData(c.settings.Id,n)};c.filterKeyPressed=function(n,t){return t.keyCode==13&&c.filterSearchClick(),!0};c.columns=ko.observableArray([]);c.rows=ko.observableArray([]);c.html=ko.observable(r);c.click=function(n,t){dialog.showBusyDialog("Processing...").then(function(){var f=n.data,i=c.settings.Columns[t],o=f[i.KeyColumn],s={currentPage:c.settings.CurrentPage,linesPerPage:c.settings.LinesPerPage,totalLines:c.settings.TotalLines},r=i.ParametersToPass||{},u,e;return(r.ViewId=c.id,r.RowId=n.id,u={Id:o,data:f,viewSettings:"",parameters:r,eventParameters:c.settings.EventParameters},c.settings.ActionType==7&&c.addViewDataToParams(u),i.Event==null||i.Event.ActionType==6)?(e=i.Event==null?i.EventNumber:i.Event.EventNumber,mainApp.executeUIAction(e,u)):(i.Event.ActionType==5?(dialog.closeBusyDialog(),dialog.getUserConfirmation(i.Event,u,r)):dialog.closeBusyDialog().then(function(){dialog.showMessage("Error","Unknown action type "+i.Event.ActionType)}),Promise.resolve())}).then(function(){dialog.closeBusyDialog()})};c.gotoPage=function(t){console.log("setting current view id to "+c.id);n.currentView=c.id;var i={viewSettings:{currentPage:t,linesPerPage:c.linesPerPage(),totalLines:c.settings.TotalLines},filter:c.filterText(),parameters:c.settings.Parameters,eventParameters:c.settings.EventParameters};c.updateViewData(c.settings.Id,i)};c.updateViewData=function(n,t){dialog.showBusyDialog("Searching...");processing.updateViewData(n,t).then(function(n){c.settings=n;c.currentPage(n.CurrentPage);c.filterText(n.Filter);c.linesPerPage(n.LinesPerPage);c.addData(n.ViewData,n.Columns);c.lastPage.notifySubscribers();dialog.closeBusyDialog()}).catch(function(n){dialog.closeBusyDialog();mainApp.handleError(n)})};c.firstClick=function(){c.gotoPage(1)};c.prevClick=function(){c.gotoPage(c.currentPage()-1)};c.nextClick=function(){c.gotoPage(c.currentPage()+1)};c.lastClick=function(){c.gotoPage(c.lastPage())};c.linesPerPageChange=function(n,t){t.originalEvent&&c.gotoPage(1)};c.visibleColumnLength=ko.computed(function(){var n=c.columns().filter(function(n){return n.visible()==!0});return n.length+1},c);c.addData=function(n){var i,t,r;for(c.rows([]),i=n||[],t=0;t<i.length;t++)r=i[t],c.addRow(r,t)};c.addRow=function(n,t){for(var u=new o(n,t),e=c.settings.Columns,r=0;r<e.length;r++){var i=e[r],s=processing.getColumnValue(i,n),h=i.ColumnType!=4&&processing.cellIsVisible(i,n),l=new f(s,h,i.ColumnType,i.ColumnSpan);u.cells.push(l)}c.rows.push(u)};c.deleteRow=function(n){return new Promise(function(t){c.rows.remove(function(t){return t.id==n});t()})};c.updateRow=function(n,i){return new Promise(function(r){var s,f,e,u;if(n>-1)for(s=c.rows(),f=t.grep(s,function(t){return t.id==n})[0],f.data=i,e=c.settings.Columns,u=0;u<e.length;u++){var o=e[u],l=processing.getColumnValue(o,i),a=o.ColumnType!=4&&processing.cellIsVisible(o,i),h=f.cells()[u];h.showCell(a);h.value(l)}else t.each(c.rows(),function(t,i){n=Math.max(n,i.id)}),n+=1,c.addRow(i,n);r()})};c.applyKoBindings=function(){var n=document.getElementById("view_"+c.id);try{ko.cleanNode(n);ko.applyBindings(c,n)}catch(t){}}}n.getViewContent=function(){return mainApp.makeWebCall("frontend/pages/Views.html")};n.showDetailsView=function(n,t,u){return dialog.showBusyDialog("Loading data..."),mainApp.makeWebCall("frontend/pages/DetailsView.html").then(function(f){var e,h,o,s,c;for(f=f.replace("##view_id##","view_"+u),e=new r(n.Title,f,n,t||!1,u,n.ViewMessage),e.detailIsHtml(n.DetailIsHtml),processing.loadViewMenu(u,e,n.DataForGettingMenu),h=n.Columns,o=0;o<h.length;o++)s=h[o],c=new i(o,s.ColumnLabel,s.ColumnType!=4,s.ColumnSpan),e.columns.push(c);return e.addData(n.ViewData),dialog.closeBusyDialog().then(function(){return Promise.resolve(e)})})};n.showListView=function(n,t,u){return dialog.showBusyDialog("Loading data..."),mainApp.makeWebCall("frontend/pages/ListView.html").then(function(f){var e,h,o,s,c;for(f=f.replace("##view_id##","view_"+u),e=new r(n.Title,f,n,t||!1,u,n.ViewMessage),processing.loadViewMenu(u,e,n.DataForGettingMenu),h=n.Columns,o=0;o<h.length;o++)s=h[o],c=new i(o,s.ColumnLabel,s.ColumnType!=4,s.ColumnSpan),e.columns.push(c);return e.addData(n.ViewData),dialog.closeBusyDialog().then(function(){return Promise.resolve(e)})})};n.currentView=-1;n.showView=function(t,f,e){return console.log("setting current view number to "+e),n.currentView=e,dialog.showBusyDialog("Loading data..."),mainApp.makeWebCall("frontend/pages/Views.html").then(function(n){var o,c,s,h,l;for(n=n.replace("##view_id##","view_"+e),o=new r(t.Title,n,t,f||!1,e,t.ViewMessage),processing.loadViewMenu(e,o,t.DataForGettingMenu),c=t.Columns,s=0;s<c.length;s++)h=c[s],l=new i(s,h.ColumnLabel,h.ColumnType!=4,h.ColumnSpan),o.columns.push(l);return o.addData(t.ViewData),dialog.closeBusyDialog().then(function(){if(t.AutoRefreshScreenTime!=null){console.log("viewdata.autorefreshscreentime: "+t.AutoRefreshScreenTime);var n=parseInt(t.AutoRefreshScreenTime);n>0&&(console.log("starting refresh for screen "+t.Title),u(o,n))}return Promise.resolve(o)})})};n.viewMenuModel=function(n,t,i,r,u){var f=this;f.label=ko.observable(n);f.eventId=t;f.menuParams=i;f.viewParams=r;f.includeDataInView=u}})(window.views=window.views||{},jQuery);
